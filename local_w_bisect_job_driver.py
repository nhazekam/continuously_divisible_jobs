...
def flat_run(job, output, split):
    ...
    time = 5000 # Time in seconds to run a batch of jobs
...
def time_limit_adjust_run(job, output, first_split, second_split, time_slice, fixed_size):
    ...
    while size_completed + size_failed < total:
        ...
        job_size_stat = JobStat(len(r_jobs), effective_worker_tp, u_size, f_size, c_size, sys_time, comp_time, split_time, join_time)
        ...
        worker_size_stat = JobStat(s_size, effective_tp, u_size, f_size, c_size, sys_time, comp_time, split_time, join_time)
